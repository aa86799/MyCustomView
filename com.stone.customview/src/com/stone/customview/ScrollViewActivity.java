...
public class ScrollViewActivity extends Activity {
	private MyScrollView myscrollVew;
...
//	private ArrayList<ImageView> imageViews;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myscrollVew = (MyScrollView) findViewById(R.id.myscrollVew);
...
//		imageViews = new ArrayList<ImageView>();
		...
		//设置监听页面改变
		myscrollVew.setOnPageChangeListener(new MyScrollView.OnPageChangeListener() {
			//刚好的ID和对应的位置下标相对应
			@Override
