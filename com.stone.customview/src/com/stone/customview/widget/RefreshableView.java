...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	public RefreshableView(Context context, AttributeSet attrs) {
		...
		header = LayoutInflater.from(context).inflate(R.layout.refresh_layout, null, true);
		progressBar = (ProgressBar) header.findViewById(R.id.pb_listview_header);
		arrow = (ImageView) header.findViewById(R.id.iv_listview_header_arrow);
		description = (TextView) header.findViewById(R.id.tv_listview_header_state);
		updateAt = (TextView) header.findViewById(R.id.tv_listview_header_last_update_time);
