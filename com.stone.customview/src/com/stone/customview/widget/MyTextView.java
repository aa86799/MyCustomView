...
public class MyTextView extends TextView {
	...
	private void initView(Context context, AttributeSet set)	 {
		...
		int width = typedArray.getInt(R.styleable.MyTextView_textwidth, 320);
		float textsize = typedArray.getDimension(
				R.styleable.MyTextView_textSize, 24);
		int textcolor = typedArray.getColor(R.styleable.MyTextView_textColor,
				-1442840576);
		float linespace = typedArray.getDimension(
				R.styleable.MyTextView_lineSpacingExtra, 15);
		int typeface = typedArray.getColor(R.styleable.MyTextView_typeface, 0);
